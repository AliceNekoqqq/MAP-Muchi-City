async function importMuchiMap(){
  const urls=[
    'https://cdn.jsdelivr.net/gh/AliceNekoqqq/MAP-Muchi-City@v2.5.0/Maps/index.js',
    'https://testingcf.jsdelivr.net/gh/AliceNekoqqq/MAP-Muchi-City@v2.5.0/Maps/index.js',
    'https://fastly.jsdelivr.net/gh/AliceNekoqqq/MAP-Muchi-City@v2.5.0/Maps/index.js'
  ];
  const errors=[];
  ...
  throw new Error('暮迟地图模块加载失败；请确认 GitHub 已创建 v2.5.0 标签并指向当前 main。'+errors.join(' | '));
}
